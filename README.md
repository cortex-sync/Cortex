...
- **Cross-AI ready** - unified profile format with per-platform adapters (Claude and Codex today; Gemini and ChatGPT planned)
...
├── profile-template/            Seeds for a new profile repo
│   ├── .gitignore               Secret-file ignore patterns (copied at setup)
│   └── memory/README.md         Memory conventions (other files generated at setup)
